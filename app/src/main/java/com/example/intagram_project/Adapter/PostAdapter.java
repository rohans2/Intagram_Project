...
import com.example.intagram_project.CommentsActivity;
import com.example.intagram_project.FollowersActivity;
import com.example.intagram_project.Fragments.PostDetailFragment;
        ...
        FirebaseDatabase.getInstance().getReference().child("Saves").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child(postId).exists()){
                    image.setImageResource(R.drawable.ic_save_dark);
                    image.setTag("saved");
                }else{
